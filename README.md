...
- 主牌選齊後，先進入至少五秒可見時間的星空追逐：本輪張數的牌背在遠方星霧中若隱若現，星辰與符文迎面掠過；若素材未完成，持續追逐，完成後以 1.8 秒在最終牌位發光浮現，切牌仍獨立留在左下角。偏好減少動態效果時取消高速運動
...
- `reading-journey.js` / `reading-journey-timing.js`：共用實體牌背的遠方星霧追逐、可視五秒與素材雙閘門、各牌位光暈浮現
